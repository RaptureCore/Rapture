...
Only requiring some minor changes is rapture.cpp.
...
Changes to rapture.cpp
----------------------
rapture.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
