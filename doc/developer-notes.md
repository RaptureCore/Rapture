...
Rapture Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Rapture Core, where everyone uses
...
pay attention to for reviewers of Rapture Core code.

General Rapture Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Rapture Core uses tinyformat, which is type safe. Leave them out to avoid confusion
