...
This mechanism has been integrated into Bitcore-Node-Rapture which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rapturepay/insight-api-rapture#web-socket-api](https://github.com/rapturepay/insight-api-rapture#web-socket-api)
* API: [https://github.com/rapturepay/insight-api-rapture#instantsend-transactions](https://github.com/rapturepay/insight-api-rapture#instantsend-transactions)
...
By default, the Rapture Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rapture Core daemon:
