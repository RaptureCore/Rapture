...
* Update translations, see [translation_process.md](https://github.com/RaptureCore/Rapture/blob/master/doc/translation_process.md#syncing-with-transifex)
...
### Build and sign Rapture Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit rapture=v${VERSION} ../rapture/contrib/gitian-descriptors/gitian-osx.yml
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [rapture-detached-sigs](https://github.com/RaptureCore/Rapture-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Rapture-development mailing list
