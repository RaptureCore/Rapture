...
#define BOOST_TEST_MODULE Rapture Test Suite

#include "test_rapture.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_rapture_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
