...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RaptureNetwork") type = RaptureNetwork;
    if(strType == "RaptureNetworkVariable") type = RaptureNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RaptureNetwork) s = "RaptureNetwork";
    if(type == RaptureNetworkVariable) s = "RaptureNetworkVariable";
