    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Rapture Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rapture: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Rapture Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rapture Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rapture Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rapture addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rapture addresses"));
    ...
    openAction->setStatusTip(tr("Open a rapture: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rapture Core help message to get a list with possible Rapture Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Rapture Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rapture network", "", count));
    } else {
...
{
    QString strTitle = tr("Rapture Core"); // default title
