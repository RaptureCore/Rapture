    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Rapture Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Rapture Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rapture-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Rapture in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RAPTURE, 0.1 RAPTURE, 1 RAPTURE and 10 RAPTURE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rapturepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://rapturepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Rapture Core is shutting down...") + "<br /><br />" +
