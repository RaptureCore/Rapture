...
#ifndef RAPTURE_NET_H
#define RAPTURE_NET_H
...
public:
    ...
    // Unfortunately, can't make this method private like in Rapture,
    // because it's used in many Rapture-specific places (masternode, privatesend).
